...
## Übersicht
### [Neues in Windows 10 Team 2020-Update](surface-hub-2020-update-whats-new.md)
...
#### [Installation und Montage des Surface Hub 2S 50-Zoll](surface-hub-2s-install-mount.md)
#### [Bewegen und Behandeln des Surface Hub 2S 85-Zoll](hub-move.md)
#### [Installation und Montage des von Surface Hub 2S 85-Zoll](surface-hub-2s-85-install-mount.md)
#### [Anpassen der Wandhalterung von Surface Hub 2S 50-Zoll](surface-hub-2s-custom-install.md)
...
### [Erstellen von Bereitstellungspaketen für Surface Hub](provisioning-packages-for-surface-hub.md)
### [Bereitstellen von Apps für Surface Hub 2S mithilfe von Intune](surface-hub-2s-deploy-apps-intune.md)
### [Erstellen lokaler Konten für Surface Hub 2S mit PowerShell](https://docs.microsoft.com/microsoftteams/rooms/with-skype-for-business-server-2015)
...
## Bereitstellen
### [Erstellen und Testen eines Gerätekontos](create-and-test-a-device-account-surface-hub.md)
#### [Onlinebereitstellung](https://docs.microsoft.com/microsoftteams/rooms/with-office-365)

#### [Lokale Bereitstellung (einzelne Gesamtstruktur)](https://docs.microsoft.com/microsoftteams/rooms/with-skype-for-business-server-2015)

#### [Lokale Bereitstellung (mehrere Gesamtstrukturen)](https://docs.microsoft.com/skypeforbusiness/deploy/deploy-clients/multiple-forest-on-premises-deployments)
...
### [Bekannte Probleme: Windows 10 Team-Betriebssystem](surface-hub-2020-team-update-known-issues.md)
### [Verwenden der Cloudwiederherstellung für BitLocker auf einem Surface Hub](use-cloud-recovery-for-bitlocker-on-surfacehub.md)
